        ...
        "/api/docs": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Введите true, чтобы документ был публичным, либо false, чтобы вы сами давали доступ",
                        "name": "public",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/api/docs/{doc_id}/remove-grant": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Тело запроса, содержит UUID пользователя, которому нужно убрать доступ",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
